...
import com.lmd.thomas.gamechoice.adapters.WordSearchGridAdapter;
import com.lmd.thomas.gamechoice.framework.WordSearchManager;
import com.lmd.thomas.gamechoice.wordSearchGenerator.generators.StringUtils;
...
import com.lmd.thomas.gamechoice.wordSearchGenerator.models.Point;
...
public class WordSearchGridView extends GridView {
    ...
    public WordSearchGridView(Context context, AttributeSet attrs) {
        ...
        mWordSearchHighlightedNodes = new ArrayList<>(mXLength);
